        ...
        <div class="card text-left">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h4 class="card-title mb-1">Ajouter un admin</h4>
                ...
                <form action="{{ route('admins.store') }}" method="post">
                    ...
                    <div class="alert alert-info">
                        Renseignez les informations de l'admin. Le mot de passe sera cree par le systeme.
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Email</label>
                                <input class="form-control" name="email" type="email" value="{{ old('email') }}" placeholder="admin@tooauto.com" required>
                            </div>
                        </div>
                    </div>

    ...
    <div class="row">
        <div class="col-lg-8 col-md-12">
            ...
            <div class="card text-left">
                <div class="card-body">
                    <h4 class="card-title mb-3">Les sous-catégories de services</h4>
                    @if($sous_categorie_services->isNotEmpty())
                        <div class="table-responsive">
                            <table class="display table table-striped table-bordered" id="language_option_table" style="width:100%">
                                ...
                                <tbody>
                                    @foreach($sous_categorie_services as $key => $item)
                                        <div class="modal fade" id="sousId{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Modifier la sous-catégorie</h5>
                                                        <button class="close" type="button" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form action="{{ route('update-sous-categorie-service', ['id' => $item->id]) }}" method="post" enctype="multipart/form-data">
                                                            @csrf
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('delete-sous-categorie-service', ['id' => $item->id]) }}" method="POST" style="display:inline;">
                                                    @csrf
                                                    @method('DELETE')
                    ...
                    @else
                        <p>Aucune sous-catégorie enregistrée.</p>
                    @endif
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-md-12">
            <h4>Ajouter une sous-catégorie de service</h4>
            <div class="card mb-5">
                <div class="card-body">
                ...
                <div class="card-body">
                    <div class="d-flex flex-column">
                        <form action="{{ route('store-ss-categorie-service') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="text-center mt-3">
                                <button type="submit" class="btn btn-secondary pd-x-20">Enregistrer la SS-catégorie</button>
                            </div>
                        </form>
                    </div>
                </div>

...
@include('layouts.fileariane')
    ...
    <div class="row">
        ...
        <div class="card text-left">
            <div class="card-body">
                <h4 class="card-title mb-3">Les villes</h4>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('update-ville', ['id' => $item->id]) }}" method="post">
                                                        @csrf
                                                        <div class="col-md-12">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" name="pays" id="">
                                                                    @foreach ($pays as $p)
                                                                        <option value="{{ $p->id }}" {{ $p->id == $item->pays_id ? 'selected' : ''}}>{{ $p->libelle }}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                        </div>
            ...
            <div class="card mb-5">
                <div class="card-body">
                    <div class="d-flex flex-column">
                        <form action="{{ route('store-ville') }}" method="post">
                            @csrf
                            <div class="form-group">
                                <label for="">Libellé</label>

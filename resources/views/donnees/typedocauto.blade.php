...
@include('layouts.fileariane')
    ...
    <div class="row">
        ...
        <div class="card text-left">
            <div class="card-body">
                <h4 class="card-title mb-3">Les types de documents auto </h4>
                @if($typedocautos->isNotEmpty() )
                    <div class="table-responsive">
                        <table class="display table table-striped table-bordered" id="language_option_table" style="width:100%">
                            ...
                            <tbody>
                                @foreach($typedocautos as $key => $item)
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('update-type-docauto', ['id' => $item->id]) }}" method="post"  enctype="multipart/form-data">
                                                        @csrf
                                                        <div class="col-md-12">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                @if (!empty($item->image))
                                                                    <img src="images/typedocautos/{{ $item->image }}" alt="">
                                                                @endif
                                                            </div>
                                                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if (!empty($item->image))
                                                <img width="50" src="images/typedocautos/{{ $item->image }}" alt="">
                                            @endif
                                        </td>
                                        <td>{{ $item->libelle }}</td>
                                        <td>
                                            ...
                                            <form action="{{ route('delete-type-docauto', ['id' => $item->id]) }}" method="POST"  style="display:inline;">
                                                @csrf
                                                @method('DELETE')
        ...
        <div class="col-lg-4 col-md-12">
            <h4>Ajouter une catégorie de type de document auto</h4>
            <div class="card mb-5">
                <div class="card-body">
                    <div class="d-flex flex-column">
                        <form action="{{ route('store-type-docauto') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label for="">Libellé</label>
